...
export const RegistrationForm: React.FC<RegistrationFormProps> = ({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Organization created successfully - pass organization data to proceed to admin creation
      const organizationId = orgData.data?.organizationId || orgData.data?.id || orgData.data?._id;
      const organizationName = orgData.data?.displayName || orgData.data?.name || formData.displayName;
